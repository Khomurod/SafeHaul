    ...
    docs: {
      description: {
        component: [
          ...
          '',
          'Density and alignment are held by pixel baselines, not by eye: the visual lane',
          'has been blocking since 2026-08-25, 172 baselines are committed, and',
          '`npm run check:table-layout` pins the column contract separately. A change to',
          'column widths or density will move a baseline — read the diff, and re-record it',
          'deliberately rather than waving it through.',
          '',
          '### Intended use',
          '',
