    ...
    docs: {
      description: {
        component: [
          ...
          '',
          '`size` selects a step on the shared control scale (`sm` 36px, `md` 44px default,',
          '`lg` 52px) — the same scale `Button` reads, so a control and its adjacent button',
          'match without an override. It deliberately shadows the native `size` attribute:',
          'control width is a layout decision, and a width set by character count could not',
          'line up with anything. See `Foundations/Control scale`.',
          '',
