    ...
    docs: {
      description: {
        component: [
          ...
          '`lg` 52px) — the same three tokens `Button` reads, so this control and the button',
          'beside it are the same height with no override at the call site. See',
          '`Foundations/Control scale`.',
        ].join('\n'),
      },
    },
  },
