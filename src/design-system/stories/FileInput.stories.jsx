    ...
    docs: {
      description: {
        component: [
          ...
          '| `variant="dropzone"` | The full-width dashed panel four uploads use. As a `<label>` the whole panel is both the click target and the browser\'s native drag-and-drop target, with no event handler |',
