...
export const SafeHaulLoader = ({ className = "", size = "h-16 w-16" }) => {
    return (
        <div className={`relative flex items-center justify-center ${className}`}>
            ...
            >
                {/* Left Part - Green Gradient */}
                <path
                    d="M84.5048 0H38.3646C35.6441 0 33.1101 1.38249 31.6377 3.67003L10.0621 37.1892C7.65527 40.9284 8.00677 45.8078 10.9247 49.1634L34.5051 76.2809C35.4547 77.373 36.831 78 38.2782 78H84.5043C85.3578 78 85.819 76.9996 85.2647 76.3506L60.1709 46.969C57.4395 43.7709 57.2872 39.1074 59.8042 35.7379L85.306 1.59845C85.7986 0.938977 85.328 0 84.5048 0Z"
                    fill="url(#loader_paint0_linear)"
                ...
                <path
                    ...
                    className="animate-s-float"
                    style={{ fill: 'var(--ds-color-brand-deep)', animationDelay: '0.15s' }}
                />
                ...
                <path
                    ...
                    className="animate-s-float"
                    style={{ fill: 'var(--ds-color-brand-mint)', animationDelay: '0.3s' }}
                />
                ...
                <path
                    ...
                    className="animate-s-float"
                    style={{ fill: 'var(--ds-color-brand-deep)', animationDelay: '0.45s' }}
                />
