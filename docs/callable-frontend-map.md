...
| `exchangeApplicationInvite` | [`publicApplyBootstrap.js`](../src/features/driver-app/components/application/publicApplyBootstrap.js) | **Guest:** open a carrier's link — returns the prepared answers, the locked employers and a resume token |
