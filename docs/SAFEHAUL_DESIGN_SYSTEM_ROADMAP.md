...
| **Pressed state** | `components/button` → `pressed` + `components/chip` | 2026-09-05 — `hand-rolled-toggle` refuses a raw `<button aria-pressed>`; 2 recorded, both `SelectableCard`'s |
